              ...
              <div className="flex items-center mb-4">
                <div className="text-5xl mr-6 bg-green-100 p-4 rounded-full min-w-[90px] h-[90px] flex justify-center items-center shadow-inner">
                  {entry.caught ? (
                    ...
                    ) : entry.type === BugType.BORNEO_FLOWER_BEETLE ? (
                      <BorneoFlowerBeetleIcon size={90} />
                    ) : entry.type === BugType.JEJU_PYGMY_STAG_BEETLE ? (
                      <JejuPygmyStagBeetleIcon size={45} />
                    ) : entry.type === BugType.MANTIS ? (
                      <MantisIcon size={80} />
                    ...
                    ) : entry.type === BugType.CYCLOMMATUS_METALLIFER ? (
