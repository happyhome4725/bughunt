...
const App: React.FC = () => {
  ...
  const spawnBug = useCallback(() => {
    ...
    else if (randomType === BugType.STAG_BEETLE) baseSize = 110;
    else if (randomType === BugType.BORNEO_FLOWER_BEETLE) baseSize = 85;
    else if (randomType === BugType.JEJU_PYGMY_STAG_BEETLE) baseSize = 45;
